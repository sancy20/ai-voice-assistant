...
WAKE_DIR = "wakeword_data/wake/nancy_train"
NOT_WAKE_DIR = "wakeword_data/not_wake"
OUT_PATH = "wakeword_model.joblib"
...
def featurize(y):
    # MFCC -> take mean + std across time (simple, strong baseline)
