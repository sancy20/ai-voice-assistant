...
WAKE_COMMAND_SILENCE_TIMEOUT_MS = float(os.getenv("WAKE_COMMAND_SILENCE_TIMEOUT_MS", "1800"))
PTT_SILENCE_TIMEOUT_MS = float(os.getenv("PTT_SILENCE_TIMEOUT_MS", "1200"))
